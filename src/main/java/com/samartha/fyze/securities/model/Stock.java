...
public class Stock extends BaseModel {
	...
	public enum Exchange {
		...
		NSE, BSE, NYSE, NASDAQ,BSE_SME,NSE_SME
	...
	public enum Sector {
		...
		INSURANCE, BROKER,ENGINEERING, CERAMICS,GLASS,PRINT_STATIONARY,SUGAR,SHIPPING,PETROCHEMICAL,REFRACTORIES,
		PACKAGING, WATER_TREATMENT,MEDIA,PLANTATION,PAPER,TOBACCO,OIL_DRILL,EDUCATION
